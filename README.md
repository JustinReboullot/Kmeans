...
Si vous souhaitez utiliser d'autres données. Il faut qu'elles soient le fichier contenant les observations ait cette forme :

Nombre_Observations Dimension x1 y1 x2 y2 ... xN yN

Le fichier contenant les cnetroids de départ doit être ainsi :
